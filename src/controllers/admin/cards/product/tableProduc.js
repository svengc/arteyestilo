...
export function adminTableProductsNormal() {
    ...
    function render() {
        ...
        container.innerHTML = tableProductTemplate(products, false);
        activateEditMode();
        activateDeleteMode();
        activateResetBtn();
        activateAddModal();
        ...
        container.querySelectorAll(".save-btn").forEach(btn => {
            btn.addEventListener("click", () => {
                ...
                updateProductById(id, {
                    // Sin descuento: no hay columna compareAtPrice → índices 0-5
                    name:           fields[0].value,
                    price:          Number(fields[1].value),
                    category:       fields[2].value,
                    material:       fields[3].value,
                    style:          fields[4].value,
                    stock:          Number(fields[5].value),
    ...
    function activateAddModal() {
        ...
        function clearForm() {
            ...
            if (disc && disc.type === "checkbox") disc.checked = false;
        }
        ...
        confirmBtn?.addEventListener("click", () => {
            ...
            const newProduct = {
                ...
                discount:       (() => { const el = container.querySelector("#new-discount"); return el?.type === "checkbox" ? el.checked : false; })(),
